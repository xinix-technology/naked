...
$("ul > li:nth-child(odd), ol > li:nth-child(odd)").addClass("odd"),$("ul > li:nth-child(even), ol > li:nth-child(even)").addClass("even"),$("table tr:first-child").addClass("first-child"),$("table tr:last-child").addClass("last-child"),$("table tr:nth-child(odd)").addClass("even"),$("table tr:nth-child(even)").addClass("odd"),$("table tr:first-child td:first-child").addClass("first-child"),$("table tr:first-child td:last-child").addClass("last-child"),$("table tr:first-child td:nth-child(odd)").addClass("even"),$("table tr:first-child td:nth-child(even)").addClass("odd"),$("table tr td:first-child").addClass("first-child"),$("table tr td:last-child").addClass("last-child"),$("table tr td:nth-child(odd)").addClass("even"),$("table tr td:nth-child(even)").addClass("odd")},$(function(){{var e=window.s4=function(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)};window.guid=function(){return e()+e()+"-"+e()+"-"+e()+"-"+e()+"-"+e()+e()+e()}}$("form .has-error:first input").focus(),$(".alert").click(function(){$(this).addClass("bounceOutRight")}),$("html").click(function(e){var t=null;return $(".sub").find("ul").fadeOut(128),$(e.target).parent().parent().hasClass("sub")?t=$(e.target).parent().parent():$(e.target).parent().hasClass("sub")?t=$(e.target).parent():$(e.target).hasClass("sub")&&(t=$(e.target)),t?(t.find("ul").fadeIn(128),e.stopPropagation(),!1):void 0}),$(".brand a").click(function(){return $(".sidebar").length>0&&$("body").toggleClass("show-sidebar"),!1}),xn.stylized()});